...
Public Class XR_WorkOrderIGST
    Private Sub XrTable3_BeforePrint_1(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles XrTable3.BeforePrint
        ...
        Dim i, j As Integer
        sqlIgst = "SELECT DISTINCT IGSTRate from WorkOrderDetail Where WorkOrderID = " + WO.Value.ToString()
        sqlLineItems = "SELECT TaxableValue,IGSTRate,IGSTAmt from WorkOrderDetail Where WorkOrderID = " + WO.Value.ToString()
    ...
    Private Sub XrTable4_BeforePrint(sender As Object, e As System.ComponentModel.CancelEventArgs)
        ...
        Dim dtIgst As New DataTable
        Dim sqlIgst As String
        sqlIgst = "SELECT ProductName, Description, HSNACS, UOM, Qty, Rate, Amount, Discount, DiscountVal, TaxableValue, IGSTRate, IGSTAmt, TotalAmount from WorkOrderDetail Where WorkOrderID = " + WO.Value.ToString()
        Try
            daIgst = New OleDbDataAdapter(sqlIgst, ConStr)
            daIgst.Fill(dtIgst)
