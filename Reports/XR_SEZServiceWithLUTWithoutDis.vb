...
Public Class XR_SEZServiceWithLUTWithoutDis
    ...
    '    XrLabel1.Text = "(""Supply under LUT number____________ without payment Of IGST"")"
    'End Sub
    ...
    Private Sub XrTable2_BeforePrint(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles XrTable2.BeforePrint
        ...
        sqlTotalAmtBfrTax = "SELECT TotalAmtBeforeTax from ServiceInvoice Where ServiceInvoiceID = " + Invoice.Value.ToString()
    ...
    Private Sub XrTable4_BeforePrint(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles XrTable4.BeforePrint
        ...
        Dim dtIgst As New DataTable
        Dim sqlIgst As String
        sqlIgst = "SELECT ProductName, Description, HSNACS, UOM, Qty, Rate, Amount, Discount, TaxableValue, IGSTRate, IGSTAmt, TotalAmount from ServiceInvoiceDetail Where ServiceInvoiceID = " + Invoice.Value.ToString()
        Try
            daIgst = New OleDbDataAdapter(sqlIgst, ConStr)
            daIgst.Fill(dtIgst)
