...
Public Class XR_ProformaServiceInvoiceIGSTWithoutDis

    'Private Sub XrLabel62_BeforePrint(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles XrLabel62.BeforePrint
    ...
    'Private Sub XrLabel72_BeforePrint(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles XrLabel72.BeforePrint
    '    Dim lbl As DevExpress.XtraReports.UI.XRLabel
    '    lbl = CType(sender, DevExpress.XtraReports.UI.XRLabel)
    '    If (lbl.Text <> lbl.Text.ToUpper()) Then
    '        lbl.Text = lbl.Text.ToUpper()
