...
Public Class XR_SEZServiceLocalWithLUT
    Private Sub XrTable3_BeforePrint(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles XrTable3.BeforePrint
        ...
        Dim i, j As Integer
        sqlCgst = "SELECT DISTINCT CGSTRate from ServiceInvoiceDetail Where ServiceInvoiceID = " + Invoice.Value.ToString()
        sqlLineItems = "SELECT TaxableValue,CGSTRate,CGSTAmt,SGSTRate,SGSTAmt from ServiceInvoiceDetail Where ServiceInvoiceID = " + Invoice.Value.ToString()
        sqlPacking = "SELECT PackingCharge,PCGSTRate,PCGSTAmt,PSGSTRate,PSGSTAmt from ServiceInvoice Where ServiceInvoiceID = " + Invoice.Value.ToString()
        ...
        Try
            ...
            For i = 0 To list1.Count - 1
                ...
                For j = 0 To dtPacking.Rows.Count - 1
                    ...
                    End If
                Next
                'taxableVal.Text = taxVal.ToString()
    ...
    Private Sub XrTable4_BeforePrint(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles XrTable4.BeforePrint
        ...
        Dim dtCgst As New DataTable
        Dim sqlCgst As String
        sqlCgst = "SELECT ProductName, Description, HSNACS, UOM, Qty, Rate, Amount, Discount, TaxableValue, CGSTRate, CGSTAmt, SGSTRate, SGSTAmt, TotalAmount from ServiceInvoiceDetail Where ServiceInvoiceID = " + Invoice.Value.ToString()
        Try
            daCgst = New OleDbDataAdapter(sqlCgst, ConStr)
            daCgst.Fill(dtCgst)
    ...
    Private Sub XrLabel16_BeforePrint(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles XrLabel16.BeforePrint
        XrLabel1.Text = "(""Supply under LUT number____________ without payment Of GST"")"
    End Sub
End Class