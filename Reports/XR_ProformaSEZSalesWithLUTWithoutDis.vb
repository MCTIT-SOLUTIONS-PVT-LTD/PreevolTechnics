...
Public Class XR_ProformaSEZSalesWithLUTWithoutDis
    ...
    Private Sub XrTable4_BeforePrint(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles XrTable4.BeforePrint
        ...
        Dim dtIgst As New DataTable
        Dim sqlIgst As String
        sqlIgst = "SELECT ProductName, Description, HSNACS, UOM, Qty, Rate, Amount, Discount, TaxableValue, IGSTRate, IGSTAmt, TotalAmount from ProformaInvoiceDetail Where ProformaInvoiceID = " + Invoice.Value.ToString()
        Try
            daIgst = New OleDbDataAdapter(sqlIgst, ConStr)
            daIgst.Fill(dtIgst)
    ...
    Private Sub XrTable3_BeforePrint(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles XrTable3.BeforePrint
        ...
        sqlTotalAmtBfrTax = "SELECT TotalAmtBeforeTax from ProformaInvoice Where ProformaInvoiceID = " + Invoice.Value.ToString()
