...
Public Class Frm_PurchaseOrder
    ...
    Sub SetDataTable()
        ...
        With DS.Tables("PurchaseOrder").Columns
            .Add("PurchaseOrderID", GetType(Integer))
            .Add("PO", GetType(String))
            .Add("PODate", GetType(Date))
            .Item("PODate").DefaultValue = Date.Today
            ...
            .Add("POType", GetType(String))
            .Item("Company").DefaultValue = PubCompanyName

        End With

        With DS.Tables("PurchaseOrder").Columns("PurchaseOrderID")
            .AutoIncrement = True
            .AutoIncrementSeed = -1
            .AutoIncrementStep = -1
            .ReadOnly = True
        ...
        DS.Tables.Add("PurchaseOrderDetail")
        With DS.Tables("PurchaseOrderDetail").Columns
            .Add("PurchaseOrderDetailID", GetType(Integer))
            .Add("PurchaseOrderID", GetType(Integer))
        ...
        With DS.Tables("PurchaseOrderDetail").Columns("PurchaseOrderDetailID")
            .AutoIncrement = True
            .AutoIncrementSeed = -1
            .AutoIncrementStep = -1
            .ReadOnly = True
    ...
    Sub SetRelation()
        DS.Relations.Add(New DataRelation("RelationPurchaseOrder", DS.Tables("PurchaseOrder").Columns("PurchaseOrderID"), DS.Tables("PurchaseOrderDetail").Columns("PurchaseOrderID"), False))
        Dim FK_PurchaseOrderDetail As New Global.System.Data.ForeignKeyConstraint("FK_PurchaseOrder", DS.Tables("PurchaseOrder").Columns("PurchaseOrderID"), DS.Tables("PurchaseOrderDetail").Columns("PurchaseOrderID"))
        DS.Tables("PurchaseOrderDetail").Constraints.Add(FK_PurchaseOrderDetail)
        With FK_PurchaseOrderDetail
        ...
        BS.DataSource = DS
        BS.DataMember = "PurchaseOrder"

        BSDetails.DataSource = BS
        BSDetails.DataMember = "RelationPurchaseOrder"

        PurchaseOrderDetailGridControl.DataSource = BSDetails
    End Sub

    Sub SetQuery()
        ' Purchase Order ......................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................
        DA.SelectCommand = New OleDbCommand("Select PurchaseOrderID,PO,PODate,DeliverySchedule,QuotRef,TransportorFOR,PaymentDays,AgainstForm,ConsignorName,ConsignorAddress,ConsignorGSTIN,ConsignorState,ConsignorStateCode,ConsignorPanNo,TotalAmtBeforeTax,CGST,SGST,IGST,TotalGSTTax,TotalAmtAfterTax,GSTReverseCharge,TotalInWords,TaxInWords,Remarks,GrandTotalAmount,RoundOff,CreatedBy,ModifiedBy,Company,POType From PurchaseOrder Where PurchaseOrderID=@PurchaseOrderID", ConStr)
        DA.SelectCommand.Parameters.Add("@PurchaseOrderID", OleDbType.Integer, 4, "PurchaseOrderID")

        DA.InsertCommand = New OleDbCommand("Insert Into PurchaseOrder (PO,PODate,DeliverySchedule,QuotRef,TransportorFOR,PaymentDays,AgainstForm,ConsignorName,ConsignorAddress,ConsignorGSTIN,ConsignorState,ConsignorStateCode,ConsignorPanNo,TotalAmtBeforeTax,CGST,SGST,IGST,TotalGSTTax,TotalAmtAfterTax,GSTReverseCharge,TotalInWords,TaxInWords,Remarks,GrandTotalAmount,RoundOff,CreatedBy,ModifiedBy,Company,POType) Values (@PO,@PODate,@DeliverySchedule,@QuotRef,@TransportorFOR,@PaymentDays,@AgainstForm,@ConsignorName,@ConsignorAddress,@ConsignorGSTIN,@ConsignorState,@ConsignorStateCode,@ConsignorPanNo,@TotalAmtBeforeTax,@CGST,@SGST,@IGST,@TotalGSTTax,@TotalAmtAfterTax,@GSTReverseCharge,@TotalInWords,@TaxInWords,@Remarks,@GrandTotalAmount,@RoundOff,@CreatedBy,@ModifiedBy,@Company,@POType)", ConStr)
        ...
        DA.InsertCommand.Parameters.Add("@POType", OleDbType.VarChar, 50, "POType")

        DA.UpdateCommand = New OleDbCommand("Update PurchaseOrder Set PO=@PO,PODate=@PODate,DeliverySchedule=@DeliverySchedule,QuotRef=@QuotRef,TransportorFOR=@TransportorFOR,PaymentDays=@PaymentDays,AgainstForm=@AgainstForm,ConsignorName=@ConsignorName,ConsignorAddress=@ConsignorAddress,ConsignorGSTIN=@ConsignorGSTIN,ConsignorState=@ConsignorState,ConsignorStateCode=@ConsignorStateCode,ConsignorPanNo=@ConsignorPanNo,TotalAmtBeforeTax=@TotalAmtBeforeTax,CGST=@CGST,SGST=@SGST,IGST=@IGST,TotalGSTTax=@TotalGSTTax,TotalAmtAfterTax=@TotalAmtAfterTax,GSTReverseCharge=@GSTReverseCharge,TotalInWords=@TotalInWords,TaxInWords=@TaxInWords,Remarks=@Remarks,GrandTotalAmount=@GrandTotalAmount,RoundOff=@RoundOff,ModifiedBy=@ModifiedBy Where PurchaseOrderID=@PurchaseOrderID", ConStr)
        ...
        DA.UpdateCommand.Parameters.Add("@PurchaseOrderID", OleDbType.Integer, 4, "PurchaseOrderID")

        DA.DeleteCommand = New OleDbCommand("Delete From PurchaseOrder Where PurchaseOrderID=@PurchaseOrderID", ConStr)
        DA.DeleteCommand.Parameters.Add("@PurchaseOrderID", OleDbType.Integer, 4, "PurchaseOrderID")

        ' PurchaseOrder Detail ..............................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................................

        DADetails.SelectCommand = New OleDbCommand("Select PurchaseOrderDetailID,PurchaseOrderID,ProductName,Description,HSNACS,UOM,Qty,Rate,Amount,Discount,DiscountVal,TaxableValue,CGSTRate,CGSTAmt,SGSTRate,SGSTAmt,IGSTRate,IGSTAmt,TotalAmount From PurchaseOrderDetail Where PurchaseOrderID=@PurchaseOrderID", ConStr)
        DADetails.SelectCommand.Parameters.Add("@PurchaseOrderID", OleDbType.Integer, 4, "PurchaseOrderID")

        DADetails.InsertCommand = New OleDbCommand("Insert Into PurchaseOrderDetail (PurchaseOrderID,ProductName,Description,HSNACS,UOM,Qty,Rate,Amount,Discount,DiscountVal,TaxableValue,CGSTRate,CGSTAmt,SGSTRate,SGSTAmt,IGSTRate,IGSTAmt,TotalAmount) Values (@PurchaseOrderID,@ProductName,@Description,@HSNACS,@UOM,@Qty,@Rate,@Amount,@Discount,@DiscountVal,@TaxableValue,@CGSTRate,@CGSTAmt,@SGSTRate,@SGSTAmt,@IGSTRate,@IGSTAmt,@TotalAmount)", ConStr)
        DADetails.InsertCommand.Parameters.Add("@PurchaseOrderID", OleDbType.Integer, 4, "PurchaseOrderID")
        ...
        DADetails.UpdateCommand = New OleDbCommand("Update PurchaseOrderDetail Set PurchaseOrderID=@PurchaseOrderID,ProductName=@ProductName,Description=@Description,HSNACS=@HSNACS,UOM=@UOM,Qty=@Qty,Rate=@Rate,Amount=@Amount,Discount=@Discount,DiscountVal=@DiscountVal,TaxableValue=@TaxableValue,CGSTRate=@CGSTRate,CGSTAmt=@CGSTAmt,SGSTRate=@SGSTRate,SGSTAmt=@SGSTAmt,IGSTRate=@IGSTRate,IGSTAmt=@IGSTAmt,TotalAmount=@TotalAmount Where PurchaseOrderDetailID=@PurchaseOrderDetailID", ConStr)
        DADetails.UpdateCommand.Parameters.Add("@PurchaseOrderID", OleDbType.Integer, 4, "PurchaseOrderID")
        ...
        DADetails.UpdateCommand.Parameters.Add("@PurchaseOrderDetailID", OleDbType.Integer, 4, "PurchaseOrderDetailID")

        DADetails.DeleteCommand = New OleDbCommand("Delete From PurchaseOrderDetail Where PurchaseOrderDetailID=@PurchaseOrderDetailID", ConStr)
        DADetails.DeleteCommand.Parameters.Add("@PurchaseOrderDetailID", OleDbType.Integer, 4, "PurchaseOrderDetailID")
    End Sub
    ...
    Sub InitLookup()
        ...
        GridComboBoxFunc("Select DISTINCT ProductName FROM POProduct", "POProduct", PurchaseOrderDetailGridControl, InvoiceDetailGridView, "ProductName", "POProduct")
        GridMemoEditFunc(PurchaseOrderDetailGridControl, InvoiceDetailGridView, "Description")
        'GridButtonEditFunc(PurchaseOrderDetailGridControl, InvoiceDetailGridView, "AddProduct")
    End Sub
    ...
    Function Validation() As Boolean
        ...
        If POTextEdit.EditValue Is DBNull.Value Then
            POTextEdit.Focus()
            Return False
    ...
    Sub AddNew()
        ...
        BS.Current!POType = PubPOType

        BS.Current!PO = GenerateNo()
    ...
    Function GenerateNo() As String
        ...
        Dim POCMD As New OleDbCommand("SELECT COUNT(PurchaseOrderID) FROM PurchaseOrder Where Company = '" + PubCompanyName + "'", ConStr)
        ...
        Dim SalesInvoicePrefix As String = "PREEVOL/PO"

        Dim newPO As String = SalesInvoicePrefix + "/" + autoPO.ToString() + "/" + FinancialYear
        Return newPO
    End Function
    ...
    Private Sub OpenBarButtonItem_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles OpenBarButtonItem.ItemClick
        ...
        Dim ID = ShowRecord("SELECT * FROM PurchaseOrder Where POType='" + PubPOType + "' AND (PurchaseOrder.PODate between #" & SubStart & "# And #" & SubEnd & "#)  AND Company='" + PubCompanyName + "' ORDER BY PODate DESC", "PurchaseOrderID")
        If ID > 0 Then
            Try
                DS.Tables("PurchaseOrderDetail").Clear()
                DS.Tables("PurchaseOrder").Clear()
            Catch
            End Try
            DA.SelectCommand.Parameters("@PurchaseOrderID").Value = ID
            DA.Fill(DS, "PurchaseOrder")
            Status = 1
            DADetails.SelectCommand.Parameters("@PurchaseOrderID").Value = ID
            DADetails.Fill(DS, "PurchaseOrderDetail")
    ...
    Private Sub DeleteBarButtonItem_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles DeleteBarButtonItem.ItemClick
        Try
            ...
            If Delete = 1 Then
                For Each row In DS.Tables("PurchaseOrderDetail").Select("PurchaseOrderID =" & BS.Current!PurchaseOrderID)
                    BSDetails.RemoveCurrent()
                    DADetails.Update(DS.Tables("PurchaseOrderDetail"))
                Next

                BS.RemoveCurrent()
                DA.Update(DS.Tables("PurchaseOrder"))
    ...
    Private Sub SaveNewSimpleButton_Click(sender As Object, e As EventArgs) Handles SaveNewSimpleButton.Click
        If Validation() Then
            If BSDetails.Count = 0 Then
                XtraMessageBox.Show("Please Enter PurchaseOrder Items", "Info")
            Else
                BS.Current!ModifiedBy = CurrentUserName
                BS.EndEdit()
                DA.Update(DS.Tables("PurchaseOrder"))
                If Status = 0 Then
                    Dim NewCMD As New OleDbCommand("SELECT MAX(PurchaseOrderID) FROM PurchaseOrder", ConStr)
                    CnnOpen() : Dim CurrentID = Val(NewCMD.ExecuteScalar & "") : CnnClose()
                    BSDetails.MoveFirst()
                    For item As Integer = 0 To BSDetails.Count - 1
                        Dim InsertCMD As New OleDbCommand("Insert Into PurchaseOrderDetail (PurchaseOrderID,ProductName,Description,HSNACS,UOM,Qty,Rate,Amount,Discount,DiscountVal,TaxableValue,CGSTRate,CGSTAmt,SGSTRate,SGSTAmt,IGSTRate,IGSTAmt,TotalAmount) Values (@PurchaseOrderID,@ProductName,@Description,@HSNACS,@UOM,@Qty,@Rate,@Amount,@Discount,@DiscountVal,@TaxableValue,@CGSTRate,@CGSTAmt,@SGSTRate,@SGSTAmt,@IGSTRate,@IGSTAmt,@TotalAmount)", ConStr)
                        InsertCMD.Parameters.AddWithValue("@PurchaseOrderID", CurrentID)
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        If Validation() Then
            If BSDetails.Count = 0 Then
                XtraMessageBox.Show("Please Enter Purchase Order Items", "Info")
            Else
                BS.Current!ModifiedBy = CurrentUserName
                BS.EndEdit()
                DA.Update(DS.Tables("PurchaseOrder"))
                ...
                ElseIf Status = 1 Then
                    ...
                    Next
                End If
                XtraMessageBox.Show("PurchaseOrder Saved Successfully...", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information)
                AddNew()
                SetCurrentData()
            End If
        End If
    ...
    Private Sub PurchaseOrderDetailGridControl_Leave(sender As Object, e As EventArgs) Handles PurchaseOrderDetailGridControl.Leave
    ...
    Private Sub PrintBarButtonItem1_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles PrintOriginalPrintBarButtonItem.ItemClick
        ...
        Dim DTCompany As New DataTable
        Dim PONo As String = BS.Current!PurchaseOrderID

        DACompany.SelectCommand = New OleDbCommand("Select CompanyID,Name,Address,Phone1,State,StateCode,EmailID1,Website,GSTIN,PANNo,ISOText From Company Where Name='" + PubCompanyName + "'", ConStr)
        DACompany.Fill(DTCompany)
        'Flag = 1
        ...
        If PubIGST = False Then
            If IsDis = True Then
                Dim Rpt As New XR_PurchaseOrder
                Rpt.PO.Value = PONo
                Rpt.PO.Visible = False
                Rpt.FillDataSource()
                'Rpt.XrLabel76.Text = "✔"
                'Company Info----
                ...
                ReportPrintTool.PreviewRibbonForm.Text = String.Format("- Purchase Order -")
                End_Waiting()

                Rpt.ShowRibbonPreviewDialog()
            Else
                Dim Rpt As New XR_PurchaseOrderWithoutDis
                Rpt.PO.Value = PONo
                Rpt.PO.Visible = False
                Rpt.FillDataSource()
                'Rpt.XrLabel76.Text = "✔"
        ...
        Else
            If IsDis = True Then
                Dim Rpt As New XR_PurchaseOrderIGST
                Rpt.PO.Value = PONo
                Rpt.PO.Visible = False
                Rpt.FillDataSource()
                'Rpt.XrLabel76.Text = "✔"
                ...
                Rpt.ShowRibbonPreviewDialog()
            Else
                Dim Rpt As New XR_PurchaseOrderIGSTWithoutDis
                Rpt.PO.Value = PONo
                Rpt.PO.Visible = False
                Rpt.FillDataSource()
                'Rpt.XrLabel76.Text = "✔"
    ...
    Private Sub POTextEdit_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles POTextEdit.Validating

        If Not POTextEdit.EditValue Is DBNull.Value Then
            Try
                Dim CMD As New OleDbCommand("SELECT Count(PurchaseOrderID) FROM PurchaseOrder WHERE PO=@PO AND PurchaseOrderID<>@PurchaseOrderID", ConStr)
                CMD.Parameters.AddWithValue("@PO", POTextEdit.EditValue)
                CMD.Parameters.AddWithValue("@PurchaseOrderID", IIf(BS.Current!PurchaseOrderID Is DBNull.Value, -1, BS.Current!PurchaseOrderID))
    ...
    Private Sub PODateDateEdit_Leave(sender As Object, e As EventArgs) Handles PODateDateEdit.Leave
        Dim DAFinance As New OleDbDataAdapter("Select StartDate,EndDate From Company Where name ='" + PubCompanyName + "'", ConStr)
        Dim DTFinance As New DataTable
        DAFinance.Fill(DTFinance)
        Dim iDate As String = PODateDateEdit.Text
    ...
    Private Sub SendEmailSimpleButton_Click(sender As Object, e As EventArgs) Handles SendEmailSimpleButton.Click
        ...
        If DTParty.Rows(0).Item("Email") IsNot DBNull.Value Then
            ...
            oMail.To = partyEmail
            oMail.Subject = "PurchaseOrder Copy"
            oMail.TextBody = " Hi Team
                        Please find attachment of Purchase Order copy for your reference.
