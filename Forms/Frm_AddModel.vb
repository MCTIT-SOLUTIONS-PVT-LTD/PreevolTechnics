...
Public Class Frm_AddModel
    ...
    Private Sub CategoryNameTextEdit_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles ModelNameTextEdit.Validating
