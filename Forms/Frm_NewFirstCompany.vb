...
'Imports ELCF
Public Class Frm_NewFirstCompany
    ...
    Sub SetQuery()
        ...
        DA.UpdateCommand.Parameters.Add("@Password", OleDbType.VarChar, 50, "Password")
        DA.UpdateCommand.Parameters.Add("@Loc", OleDbType.VarChar, 50, "Loc")
        DA.UpdateCommand.Parameters.Add("@Pin", OleDbType.VarChar, 50, "Pin")
