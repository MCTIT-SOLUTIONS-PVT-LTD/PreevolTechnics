...
Public Class Frm_ProformaInvoiceNew
    ...
    Sub SetRelation()
        DS.Relations.Add(New DataRelation("RelationProformaInvoice", DS.Tables("ProformaInvoice").Columns("ProformaInvoiceID"), DS.Tables("ProformaInvoiceDetail").Columns("ProformaInvoiceID"), False))
        Dim FK_ProformaInvoiceDetail As New Global.System.Data.ForeignKeyConstraint("FK_ProformaInvoice", DS.Tables("ProformaInvoice").Columns("ProformaInvoiceID"), DS.Tables("ProformaInvoiceDetail").Columns("ProformaInvoiceID"))
        DS.Tables("ProformaInvoiceDetail").Constraints.Add(FK_ProformaInvoiceDetail)
        With FK_ProformaInvoiceDetail
        ...
        BSDetails.DataMember = "RelationProformaInvoice"
    ...
    Function GenerateNo() As String
        Dim DAFinance As New OleDbDataAdapter("Select FinancialYearID,FinancialYear,ProformaSalesInvoiceCount From FinancialSettings Where Company ='" + PubCompanyName + "' AND FinancialYear = '" + GetCurrentYear() + "'", ConStr)
        Dim DTFinance As New DataTable
        DAFinance.Fill(DTFinance)
        Dim DACompany As New OleDbDataAdapter("Select CompanyID,ProformaSalesInvoicePrefix From Company Where Name ='" + PubCompanyName + "'", ConStr)
        Dim DTCompany As New DataTable
        DACompany.Fill(DTCompany)
        ...
        Dim SalesInvoicePrefix As String = DTCompany.Rows(0).Item("ProformaSalesInvoicePrefix").ToString
        ...
        'Dim DAFinance As New OleDbDataAdapter("Select ID,FinancialYear,SalesInvoiceCount From FinancialSettings Where Company ='" + PubCompanyName + "'", ConStr)
        'Dim DTFinance As New DataTable
        'DAFinance.Fill(DTFinance)

        'Dim WOCMD As New OleDbCommand("SELECT COUNT(ProformaInvoiceID) FROM ProformaInvoice Where Company = '" + PubCompanyName + "'", ConStr)
        ...
        'Dim SalesInvoicePrefix As String = "PRO-S/G"
    ...
    Private Sub InvoiceDetailGridView_CustomColumnDisplayText(ByVal sender As Object, ByVal e As CustomColumnDisplayTextEventArgs) Handles InvoiceDetailGridView.CustomColumnDisplayText
        If PubInvoiceType = "Export Sales Proforma Invoice IGST" Then
    ...
    Private Sub InvoiceNoTextEdit_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles InvoiceNoTextEdit.Validating
        ...
        If Not InvoiceNoTextEdit.EditValue Is DBNull.Value Then
            Try
                Dim CMD As New OleDbCommand("SELECT Count(ProformaInvoiceID) FROM ProformaInvoice WHERE InvoiceNo=@InvoiceNo AND ProformaInvoiceID<>@ProformaInvoiceID", ConStr)
                CMD.Parameters.AddWithValue("@InvoiceNo", InvoiceNoTextEdit.EditValue)
                CMD.Parameters.AddWithValue("@ProformaInvoiceID", IIf(BS.Current!ProformaInvoiceID Is DBNull.Value, -1, BS.Current!ProformaInvoiceID))
