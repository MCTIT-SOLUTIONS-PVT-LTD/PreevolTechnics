...
'Imports ELCF
Public Class Frm_AddPlungerDia
    ...
    Private Sub SaveSimpleButton_Click(sender As Object, e As EventArgs) Handles SaveSimpleButton.Click
        If Validation() Then
            ...
            XtraMessageBox.Show("Model added successfully...", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    End Sub
    ...
    Private Sub CategoryNameTextEdit_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles DiameterNameTextEdit.Validating
