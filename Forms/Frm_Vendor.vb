...
Public Class Frm_Vendor
    ...
    Function SetQuery()
        ...
        DA.InsertCommand.Parameters.Add("@VendorName", OleDbType.VarChar, 100, "VendorName")
        ...
        DA.UpdateCommand.Parameters.Add("@VendorName", OleDbType.VarChar, 100, "VendorName")
