...
Public Class Frm_Party
    ...
    Function SetQuery()
        DA.SelectCommand = New OleDbCommand("Select PartyID,PartyName,ContactPerson,Contact1,Contact2,Address,City,State,Country,StateCode,Email,Website,GSTStatus,GSTIN,PANNo,VATNo,CSTNo,ECCNo,IECCode,Company,Pin From Party Where PartyID=@PartyID", ConStr)
        DA.SelectCommand.Parameters.Add("@PartyID", OleDbType.Integer, 4, "PartyID")

        DA.InsertCommand = New OleDbCommand("Insert Into Party (PartyName,ContactPerson,Contact1,Contact2,Address,City,State,Country,StateCode,Email,Website,GSTStatus,GSTIN,PANNo,VATNo,CSTNo,ECCNo,IECCode,Company,Pin) Values (@PartyName,@ContactPerson,@Contact1,@Contact2,@Address,@City,@State,@Country,@StateCode,@Email,@Website,@GSTStatus,@GSTIN,@PANNo,@VATNo,@CSTNo,@ECCNo,@IECCode,@Company,@Pin)", ConStr)
        ...
        DA.InsertCommand.Parameters.Add("@Country", OleDbType.VarChar, 150, "Country")
        ...
        DA.UpdateCommand = New OleDbCommand("Update Party Set PartyName=@PartyName,ContactPerson=@ContactPerson,Contact1=@Contact1,Contact2=@Contact2,Address=@Address,City=@City,State=@State,Country=@Country,StateCode=@StateCode,Email=@Email,Website=@Website,GSTStatus=@GSTStatus,GSTIN=@GSTIN,PANNo=@PANNo,VATNo=@VATNo,CSTNO=@CSTNO,ECCNo=@ECCNo,IECCode=@IECCode,Pin=@Pin Where PartyID=@PartyID", ConStr)
        ...
        DA.UpdateCommand.Parameters.Add("@Country", OleDbType.VarChar, 150, "Country")
    ...
    Function SetBinding()
        ...
        CountryComboBoxEdit.DataBindings.Add(New Binding("EditValue", BS, "Country"))
    ...
    Function Validation() As Boolean
        ...
        ElseIf StateTextEdit.EditValue Is DBNull.Value Then
            StateTextEdit.Focus()
            Return False
        ElseIf CountryComboBoxEdit.EditValue Is DBNull.Value Then
            CountryComboBoxEdit.Focus()
            Return False
