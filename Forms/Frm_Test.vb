...
Public Class Frm_Test
    ...
    Private Sub FrmSimple_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        PanelCtrlDetailMain.Dock = DockStyle.Fill
        themes(PanelCtrlDetail)
    End Sub
    ...
    'Private Sub SubCategoryNameTextEdit_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs)
