Module InWord_Module
    ...
    Function AmtInWord(ByVal Num As Decimal) As String
        ...
        Return AmtInWord
    End Function
    Function USAmtInWord(ByVal Num As Decimal) As String
        'I have created this function for converting amount in USD Dollar (USD). 
        'You can manipulate as you wish like decimal setting, Doller (any currency) Prefix.
        ...
        If InStr(1, strNum, ".") <> 0 Then
            ...
            strNum = Mid(strNum, 1, InStr(1, strNum, ".") - 1)
            StrWord = IIf(CDbl(strNum) = 1, " U.S Dollar ", " U.S Dollars ") + NumToWord(CDbl(strNum)) + IIf(CDbl(strNumDec) > 0, " and Cents" + cWord3(CDbl(strNumDec)), "")
        Else
            StrWord = IIf(CDbl(strNum) = 1, " U.S Dollar ", " U.S Dollars ") + NumToWord(CDbl(strNum))
        End If
        USAmtInWord = StrWord & " Only"
        Return USAmtInWord
    End Function
